...
const validateForm = (targetName, targetValue) => {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        // await axios.put("http://localhost:9191/api/admin/updateDoctor", doctor);
        ...
        try{
            ...
            const response=await adminService.updateDoctor(doctor);
        ...
        <div className="container">
            <div className="row">
                <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
                    <h2 className="text-center m-4"> Update Doctor Details </h2>
